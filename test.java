...
import me.Tiernanator.Portalz.Enums.BlockDirection;
...
//		};
		BlockDirection[] blockDirections = BlockDirection.DOWN.getClass().getEnumConstants();
		for (BlockDirection direction : blockDirections) {
			Block s = BlockDirection.getRelativeBlock(b, direction);
